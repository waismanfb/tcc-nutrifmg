...
class GruposController extends Controller
{
    ...
    public function media($totais, $quantidadeRegistros)
    {
        ...
        $totais['lipideos']         = round($totais['lipideos']       / $quantidadeRegistros, 2);
        $totais['colesterol']       = round($totais['colesterol']     / $quantidadeRegistros, 2);
        $totais['carboidrato']      = round($totais['carboidrato']    / $quantidadeRegistros, 2);
        $totais['fibraAlimentar']   = round($totais['fibraAlimentar'] / $quantidadeRegistros, 2);
        $totais['cinzas']           = round($totais['cinzas']         / $quantidadeRegistros, 2);
        $totais['calcio']           = round($totais['calcio']         / $quantidadeRegistros, 2);
        $totais['magnesio']         = round($totais['magnesio']       / $quantidadeRegistros, 2);
        $totais['manganes']         = round($totais['manganes']       / $quantidadeRegistros, 2);
        $totais['fosforo']          = round($totais['fosforo']        / $quantidadeRegistros, 2);
        $totais['ferro']            = round($totais['ferro']          / $quantidadeRegistros, 2);
        $totais['sodio']            = round($totais['sodio']          / $quantidadeRegistros, 2);
        $totais['potassio']         = round($totais['potassio']       / $quantidadeRegistros, 2);
        $totais['cobre']            = round($totais['cobre']          / $quantidadeRegistros, 2);
        $totais['zinco']            = round($totais['zinco']          / $quantidadeRegistros, 2);
        $totais['retinol']          = round($totais['retinol']        / $quantidadeRegistros, 2);
        $totais['re']               = round($totais['re']             / $quantidadeRegistros, 2);
        $totais['rae']              = round($totais['rae']            / $quantidadeRegistros, 2);
        $totais['tiamina']          = round($totais['tiamina']        / $quantidadeRegistros, 2);
        $totais['riboflavina']      = round($totais['riboflavina']    / $quantidadeRegistros, 2);
        $totais['piridoxina']       = round($totais['piridoxina']     / $quantidadeRegistros, 2);
